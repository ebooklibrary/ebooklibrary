 ...
 */
	...
	var gh=["-Select-","판타지","공상과학","호러","드라마","액션및어드벤처","로맨스","미스터리(추리)","시리즈","트릴로지(3부작)","만화","풍자","전기","자서전","아동도서","일기형식","자기계발서","가이드","여행","종교","기도","역사","수학","시(선집),문집","시집","저널,학술지","백과사전","사전","과학","예술","요리","헬스","문화","경제"];
	/* 책 장르 */
	var l="";
