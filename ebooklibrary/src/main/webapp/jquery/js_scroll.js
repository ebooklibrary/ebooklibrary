...
var js_rolling = function(this_s){
	...
	this.time_dealy_pause = 1500;//하나의 대상이 새로 시작할 때 멈추는 시간, 0 이면 적용 안함
...
js_rolling.prototype.stop = function(){ //롤링을 끝냄
	...
	js_rolling.prototype.r_stop = function(){ //롤링을 끝냄
	this.new_is_rolling = false;
	clearInterval(this.time_timer);
}

js_rolling.prototype.s_stop = function(){ //롤링을 끝냄
	this.is_rolling = false;
