	...
	$(function() {
		$("#btnCharge").click(function() {
			window.open("<c:url value='/cash/cashAdd.do'/>",
					"cashAdd",
			"width=750,height=500,left=50,top=50,resizable=yes,location=yes");
			});
		});	
</script>
...
<div id="myInfoBackImg" class="mpSpanVal" style="width: 80px;height: 80px;background-image: url('${pageContext.request.contextPath}/backimg/${memberVo.bgImage }');
