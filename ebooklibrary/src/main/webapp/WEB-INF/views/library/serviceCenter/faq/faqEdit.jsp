		...
		<form name="frmWrite" id="frmWrite" method="post" 			
			...
			<fieldset>
				<legend>FAQ 작성하기</legend>
					<input type="text" name="faqNo" value="${faqDetail.faqNo}">
					...
					<div>
						<div id="faqheader">
							...
							<input type="text" class="inputfaqText" id="title" name="title" value="${faqDetail.title }" />
						</div>	
					</div>
					<textarea class="w3-input" name="content" id="content" rows="10" cols="100" style="width:705px; height:300px;">${faqDetail.content }</textarea>
		        	<br>
