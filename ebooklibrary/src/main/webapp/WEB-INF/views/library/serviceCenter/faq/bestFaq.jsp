				...
				<c:if test="${!empty bestFAQ}">
					<c:forEach var="vo" items="${bestFAQ}">
						...
						<li id="FAQ_List_${i }" name="TrFAQ_Content" class="off">
							<dl class="faqDl">
								<dt class="faqdt">${vo.faqNo}</dt><dd class="faqdd"><span class="bfaqtitle"> ${vo.category }     </span> <span><a class="callContent" href='javascript:void(0);' onclick='viewContent(${i });'>${vo.title }</a></span></dd>
							</dl>
